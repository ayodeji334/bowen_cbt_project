                            ...
                            <div className="h-full w-full">
                                <div className="w-full h-full flex flex-col justify-center items-center">
                                    <div className="w-9/12 lg:w-3/5 py-4">
                                        ...
                                        <p className="pb-4 text-sm">Enter your matric number and password to start the exam</p>
                                        <form onSubmit={handleLogin} className="py-9">
                                            ...
                                            <div className="mb-1">
                                                <label className="block text-black capitalize text-base font-bold mb-2" htmlFor="password">
                                                    Password
                                            </label>
                                                <input
                                                    className="
                                                border-2 rounded-md w-full py-4 px-3
                                                ...
                                                />
                                                <span 
                                                    className="float-right -mt-16 cursor-pointer p-3 mr-3 z-10 relative" 
                                            ...
                                            <button
                                                ...
                                                text-white font-semibold py-5 focus:outline-none focus:shadow-outline` : `flex flex-row justify-center 
                                                    items-center w-full mt-7 
                                                    shadow-lg rounded-full bg-blue-900 
                                                    hover:bg-blue-600 text-base 
                                                    text-white font-semibold py-4 
                                                    focus:outline-none focus:shadow-outline`
                                                }
                                                type="submit">
                                                    {
                                                        loading ? "Loading..." : isAuthSuccess ? <FaCheck /> : "Login"
                                                    }
                                            </button>
                                            </div>
                                        </form>
                                        <div className="my-6">
                                            <p className="text-black font-medium text-base">
                                                ...
                                                <Link href="/register">
                                                    <a className="pl-2 text-base text-blue-700 hover:text-red">Register</a>
                                                </Link>
                                            </p>
                                        </div>
                                    </div>
